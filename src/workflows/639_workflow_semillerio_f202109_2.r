...
DT_incorporar_dataset_competencia2024 <- function()
{
  ...
  param_local$meta$script <- "/src/wf-etapas/z511_DT_incorporar_dataset.r"
...
CA_catastrophe_base <- function( pinputexps, metodo )
{
  ...
  param_local$meta$script <- "/src/wf-etapas/z521_CA_reparar_dataset.r"
...
DR_drifting_base <- function( pinputexps, metodo)
{
  ...
  param_local$meta$script <- "/src/wf-etapas/541_DR_corregir_drifting_uva.r"
...
TS_strategy_base9 <- function(pinputexps) {
  ...
  param_local$final_train <- c(202107, 202106, 202105, 202104,
                               ...
                               202007, 202005, 202004)
  
  param_local$train$training <- c(202103, 202102, 202101, 202012,
                                  202011, 202010, 202009, 202008, 
                                  202007, 202005, 202004, 202003, 
                                  202002, 202001, 201912,
                                  202108, 202109, 202110) # Agregar meses adicionales
  
  param_local$train$validation <- c(202106, 202108) # Agregar meses adicionales
  param_local$train$testing <- c(202107, 202105, 202104, 202109) # Agregar meses adicionales
  
  # Atención 0.2 de undersampling de la clase mayoritaria, los CONTINUA
...
ZZ_final_semillerio_base9 <- function( pinputexps )
{
  if( -1 == (param_local <- exp_init())$resultado ) return( 0 )# linea fija

  param_local$meta$script <- "/src/wf-etapas/z593_ZZ_final_semillerio.r"
...
wf_sept_semillerio <- function( pnombrewf )
{
  ...
  ZZ_final_semillerio_base9( c(ht, ts9) )
